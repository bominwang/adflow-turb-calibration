...
contains
    ...
    logical function lessEqualHaloListType(g1, g2)
       ...
       use complexify 
        ...
        boundary: if (g1%donorProc .ceq. -1) then ! And thus
            ! g2%donorProc == -1
...
contains
    ...
    logical function equalCGNSPeriodicType(g1, g2)
       ...
       use complexify 
        ...
        if ((g1%cgnsBlock .ceq. g2%cgnsBlock) .and. &
            (g1%cgnsSubface .ceq. g2%cgnsSubface)) &
    ...
    logical function equalPeriodicSubfacesHaloT(g1, g2)
       ...
       use complexify 
        ...
        if (g1%nPeriodicSubfaces .cne. g2%nPeriodicSubfaces) then
            equalPeriodicSubfacesHaloT = .false.
            return
        end if

        do nn = 1, g1%nPeriodicSubfaces
            if (g1%periodicSubfaces(nn) .cne. g2%periodicSubfaces(nn)) then
                equalPeriodicSubfacesHaloT = .false.
                return
            end if
        end do
