 ...
 contains
    subroutine inviscidCentralFlux
       ...
       use complexify 
        ...
        complex(kind=realType) :: pa, fs, sFace, vnp, vnm
    ...
    subroutine inviscidDissFluxMatrix
       ...
       use complexify 
        ...
        complex(kind=realType), dimension(1:ie, 1:je, 1:ke, 3) :: dss
        logical :: correctForK
    ...
    subroutine inviscidDissFluxScalar
       ...
       use complexify 
        ...
        complex(kind=realType) :: sfil, fis2, fis4
        complex(kind=realType) :: ppor, rrad, dis2, dis4
        complex(kind=realType) :: ddw1, ddw2, ddw3, ddw4, ddw5, fs
        complex(kind=realType), dimension(1:ie, 1:je, 1:ke, 3) :: dss
        complex(kind=realType), dimension(0:ib, 0:jb, 0:kb) :: ss
    ...
    subroutine viscousFlux
       ...
       use complexify 
        ...
        complex(kind=realType), parameter :: xminn = 1.e-14_realType
        !
        !      Local variables.
        !
        ...
        complex(kind=realType) :: den, Ccr1, fact
        ...
        else if ((rkStage .ceq. 0) .and. (currentLevel .ceq. groundLevel)) then
            storeWallTensor = .true.
        end if
            ...
            do k = 1, kl
                do j = 2, jl
                    do i = 2, il
                        ...
                        if ((k .ceq. 1) .and. storeWallTensor .and. &
                        ...
                        ! And the k == kl case.
                        if ((k .ceq. kl) .and. storeWallTensor .and. &
            ...
            do k = 2, kl
                do j = 1, jl
                    do i = 2, il
                        ...
                        if ((j .ceq. 1) .and. storeWallTensor .and. &
                        ...
                        if ((j .ceq. jl) .and. storeWallTensor .and. &
            ...
            do k = 2, kl
                do j = 2, jl
                    do i = 1, il
                        ...
                        if ((i .ceq. 1) .and. storeWallTensor .and. &
                        ...
                        if ((i .ceq. il) .and. storeWallTensor .and. &
    ...
    subroutine inviscidDissFluxScalarApprox
       ...
       use complexify 
        ...
        complex(kind=realType) :: sslim, rhoi
        complex(kind=realType) :: sfil, fis2, fis4
        complex(kind=realType) :: ppor, rrad, dis2
        complex(kind=realType) :: dss1, dss2, ddw, fs
    ...
    subroutine inviscidDissFluxMatrixApprox
       ...
       use complexify 
        ...
        complex(kind=realType) :: gammaAvg, gm1, ovgm1, gm53
        complex(kind=realType) :: ppor, rrad, dis2
        complex(kind=realType) :: dp1, dp2, ddw, tmp, fs
        complex(kind=realType) :: dr, dru, drv, drw, dre, drk, sx, sy, sz
        complex(kind=realType) :: uAvg, vAvg, wAvg, a2Avg, aAvg, hAvg
        complex(kind=realType) :: alphaAvg, unAvg, ovaAvg, ova2Avg
        complex(kind=realType) :: kAvg, lam1, lam2, lam3, area
    ...
    subroutine inviscidDissFluxScalarCoarse
       ...
       use complexify 
        ...
        complex(kind=realType) :: sfil, fis0, dis0, ppor, fs, rhoi
    ...
    subroutine inviscidDissFluxMatrixCoarse
       ...
       use complexify 
        ...
        complex(kind=realType) :: sfil, fis0, dis0, ppor, rrad, sface
        complex(kind=realType) :: gammaAvg, gm1, ovgm1, gm53, tmp, fs
        complex(kind=realType) :: dr, dru, drv, drw, dre, drk, sx, sy, sz
        complex(kind=realType) :: uAvg, vAvg, wAvg, a2Avg, aAvg, hAvg
        complex(kind=realType) :: alphaAvg, unAvg, ovaAvg, ova2Avg
        complex(kind=realType) :: kAvg, lam1, lam2, lam3, area
