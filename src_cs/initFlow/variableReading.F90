module variableReading
    ...
    complex(kind=realType) :: rhoScale, velScale, pScale, muScale
...
contains
    subroutine readDensity(nTypeMismatch)
       ...
       use complexify 
        ...
        if (nn > 0) then
            ...
            if (realTypeCGNS .cne. varTypes(nn)) &
    ...
    subroutine readEnergy(nTypeMismatch)
       ...
       use complexify 
        ...
        complex(kind=realType) :: vvx, vvy, vvz, dummyK, pres, rhoInv
    ...
    subroutine readTurbKwType(nTypeMismatch)
       ...
       use complexify 
        ...
        complex(kind=realType) :: nuScale, kScale, omegaScale, val
        ...
        if (turbKPresent) then
            ...
            if (((myID .ceq. 0)) .and. ((nbkLocal .ceq. 1))) then
...
1001    select case (turbModel)
    ...
    subroutine readTurbSA(nTypeMismatch)
       ...
       use complexify 
        ...
        complex(kind=realType) :: nuScale, ratio, nu
    ...
    subroutine readTurbV2f(nTypeMismatch)
       ...
       use complexify 
        ...
        complex(kind=realType) :: nuScale, kScale, epsScale, fScale

        complex(kind=realType), dimension(4) :: turbScale
    ...
    subroutine readXmomentum(nTypeMismatch)
       ...
       use complexify 
        ...
        complex(kind=realType) :: momScale
    ...
    subroutine readTimeHistory(fileIDs)
       ...
       use complexify 
        ...
        do i = 1, nConv
            ...
            if (nSize(1) .cne. nTimeStepsRestart) then
                print "(a)", "#"
                print "(a)", "#                 Warning"
...
99      continue
    ...
    subroutine scaleFactors(fileIDs)
       ...
       use complexify 
        ...
        do i = 1, nRef
            ...
            if ((nDim .cne. 1) .or. (nsize2(1) .cne. 1)) &
    ...
    subroutine readRestartVariable(cgnsVarName)
       ...
       use complexify 
        ...
        locationTest: if (location .ceq. CellCenter) then
