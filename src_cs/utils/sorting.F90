 ...
 contains
    ...
    subroutine qsortReals(arr, nn)
       ...
       use complexify 
        ...
        !      Subroutine arguments
        !
        complex(kind=realType), dimension(*), intent(inout) :: arr
        integer(kind=intType), intent(in) :: nn
        !
        !      Local variables
        !
    ...
    function bsearchReals(key, base)
       ...
       use complexify 
        ...
        !      Function arguments.
        !
        complex(kind=realType), intent(in) :: key
        complex(kind=realType), dimension(:), intent(in) :: base
        integer(kind=intType) :: nn
        !
        !      Local variables.
        !
