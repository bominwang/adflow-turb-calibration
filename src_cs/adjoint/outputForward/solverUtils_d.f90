...
! directions.
                temp0 = ri/rj
                if (temp0 .le. 0.0_8 .and. ((adis .ceq. 0.0_8) .or. (adis &
&                   .cne. int(adis)))) then
                  rijd = 0.0_8
                else
