...
!
    ...
    complex(kind=realtype), intent(in) :: rhod, pd, ud, vd, wd
    complex(kind=realtype), intent(out) :: ttot
    complex(kind=realtype), intent(out) :: ttotd
!
!      local variables.
!
...
!
    ...
    complex(kind=realtype), intent(out) :: ptotd
!
!      local parameters.
!
...
!
    ...
    complex(kind=realtype), intent(in) :: rhod, pd, kd
    complex(kind=realtype), intent(in) :: u, v, w
    complex(kind=realtype), intent(in) :: ud, vd, wd
    complex(kind=realtype), intent(out) :: etotal
    complex(kind=realtype), intent(out) :: etotald
    logical, intent(in) :: correctfork
!
!      local variables.
!
...
!
    ...
    complex(kind=realtype), intent(out) :: einternald
    logical, intent(in) :: correctfork
!
!      local parameter.
!
...
!
    ...
    complex(kind=realtype), dimension(3, 3), intent(out) :: rotationmatrixd
!
!      local variables.
!
...
!
    ...
    complex(kind=realtype), dimension(3), intent(out) :: winddirectiond
...
!
    ...
    complex(kind=realtype), intent(in) :: angled, xd, yd, zd
    complex(kind=realtype), intent(out) :: xp, yp, zp
    complex(kind=realtype), intent(out) :: xpd, ypd, zpd
    intrinsic cos
    intrinsic sin
    complex(kind=realtype) :: temp
    complex(kind=realtype) :: temp0
