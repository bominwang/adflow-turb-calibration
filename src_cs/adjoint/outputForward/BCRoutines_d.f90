...
! compute the state in the halo.
      temp0 = pexit/ss
      if (temp0 .le. 0.0_8 .and. ((ovg .ceq. 0.0_8) .or. (ovg .cne. int(ovg)))&
&     ) then
        ww1d(i, j, irho) = 0.0_8
      else
...
! the gas law.
          ...
          ts = a2/temp0
          temp0 = ts/ttot
          if (temp0 .le. 0.0_8 .and. ((govgm1 .ceq. 0.0_8) .or. (govgm1 .cne.&
&             int(govgm1)))) then
            ratiod = 0.0_8
          else
...
! the entropy of the free stream.
    ...
    if (winf(irho) .le. 0.0_8 .and. ((gammainf .ceq. 0.0_8) .or. (gammainf &
...
&         , 3)
        ...
        if (temp0 .le. 0.0_8 .and. ((temp .ceq. 0.0_8) .or. (temp .cne. int(&
&           temp)))) then
          tempd0 = 0.0_8
        else
...
! halo cell.
      ...
      temp2 = sf*cc
      if (temp2 .le. 0.0_8 .and. ((ovgm1 .ceq. 0.0_8) .or. (ovgm1 .cne. int(&
&         ovgm1)))) then
        ww1d(i, j, irho) = 0.0_8
      else
