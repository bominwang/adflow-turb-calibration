...
! --------------------------------------------------
  subroutine fractoweights_d(frac, fracd, weights, weightsd)
    ...
    complex(kind=realtype), dimension(3), intent(in) :: fracd
    complex(kind=realtype), dimension(8), intent(out) :: weights
    complex(kind=realtype), dimension(8), intent(out) :: weightsd
...
! input
    ...
    complex(kind=realtype), dimension(3), intent(in) :: xcend
    complex(kind=realtype), dimension(3, 3, 3, 3), intent(in) :: blk
    complex(kind=realtype), dimension(3, 3, 3, 3), intent(in) :: blkd
    complex(kind=realtype), dimension(3), intent(in) :: frac0
! output
    complex(kind=realtype), dimension(3), intent(out) :: frac
    complex(kind=realtype), dimension(3), intent(out) :: fracd
! working
