...
&   , rmu
    complex(kind=realtype) :: uuxd, uuyd, uuzd, cc2d, qsid, qsjd, qskd
...
! is negligible.
            ...
            temp0 = rk/ri
            if (temp0 .le. 0.0_8 .and. ((adis .ceq. 0.0_8) .or. (adis .cne. &
&               int(adis)))) then
              tempd = 0.0_8
            else
...
branch = myIntStack(myIntPtr)
 myIntPtr = myIntPtr - 1
          ...
          temp0 = sx*sx + sy*sy + sz*sz
          abs1d = half*rjd
          if (.not.(temp0*cc2 .ceq. 0.0_8)) cc2d = cc2d + temp0*&
