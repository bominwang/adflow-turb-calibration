...
!
    ...
    complex(kind=realtype) :: xpd, ypd, zpd, vp1d, vp2d, vp3d, vp4d, vp5d, &
&   vp6d
...
! some additional safety stuff for halo volumes.
    ...
    do k=ke,1,-1
      do j=je,1,-1
        do i=ie,1,-1
          call popcontrol1b(branch)
          if (branch .cne. 0) vold(i, j, k) = -vold(i, j, k)
...
!
      ...
      complex(kind=realtype) :: volumed
!
!        function arguments.
!
      complex(kind=realtype), intent(in) :: xa, ya, za, xb, yb, zb
      complex(kind=realtype) :: xad, yad, zad, xbd, ybd, zbd
      complex(kind=realtype), intent(in) :: xc, yc, zc, xd, yd, zd
      complex(kind=realtype) :: xcd, ycd, zcd, xdd, ydd, zdd
      complex(kind=realtype) :: tempd
      complex(kind=realtype) :: tempd0
      complex(kind=realtype) :: tempd1
      complex(kind=realtype) :: tempd2
      complex(kind=realtype) :: tempd3
      complex(kind=realtype) :: tempd4
      complex(kind=realtype) :: tempd5
      complex(kind=realtype) :: tempd6
      complex(kind=realtype) :: tempd7
...
! local variables.
    ...
    complex(kind=realtype) :: xxp, yyp, zzp
    complex(kind=realtype), dimension(3) :: v1, v2
    complex(kind=realtype), dimension(3) :: v1d, v2d
    intrinsic mod
    complex(kind=realtype) :: tempd
...
! local variables.
    ...
    complex(kind=realtype) :: xxp, yyp, zzp
    complex(kind=realtype) :: xxpd, yypd, zzpd
    intrinsic mod
    intrinsic sqrt
    complex(kind=realtype) :: tempd
    integer :: branch
...
! and possibly correct for inward pointing.
        ...
        if (xxp**2 + yyp**2 + zzp**2 .ceq. 0.0_8) then
          tempd = 0.0_8
        else
...
!
    ...
    complex(kind=realtype) :: dotd
    complex(kind=realtype), dimension(3) :: v1, v2, norm
    complex(kind=realtype), dimension(3) :: v1d
    intrinsic sqrt
    complex(kind=realtype) :: tmp
    complex(kind=realtype) :: tmpd
    complex(kind=realtype) :: tmp0
