...
&         term2d
        ...
        if (temp0 .le. 0.0_8 .and. ((sixth .ceq. 0.0_8) .or. (sixth .cne. int&
&           (sixth)))) then
          gg6d = 0.0_8
        else
        ...
        if (branch .cne. 0) then
          ...
          if (.not.(two*strainmag2 .ceq. 0.0_8)) strainmag2d = strainmag2d &
