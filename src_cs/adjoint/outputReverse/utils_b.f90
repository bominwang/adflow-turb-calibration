...
!
    ...
    complex(kind=realtype) :: derivativerigidrotangled
!
!      function arguments.
!
...
!
    ...
    intrinsic cos
! return immediately if this is a steady computation.
    if (equationmode .cne. steady) then
...
!   with respect to varying inputs: x
  subroutine mynorm2_b(x, xd, mynorm2d)
    ...
    complex(kind=realtype), dimension(3) :: xd
    complex(kind=realtype) :: mynorm2
    complex(kind=realtype) :: mynorm2d
    intrinsic sqrt
    complex(kind=realtype) :: tempd
    xd = 0.0_8
    if (x(1)**2 + x(2)**2 + x(3)**2 .ceq. 0.0_8) then
      tempd = 0.0_8
    else
...
! inputs
    ...
    complex(kind=realtype), dimension(3) :: ad, bd
! outputs
    complex(kind=realtype), dimension(3) :: c
    complex(kind=realtype), dimension(3) :: cd
    ad = 0.0_8
    bd = 0.0_8
