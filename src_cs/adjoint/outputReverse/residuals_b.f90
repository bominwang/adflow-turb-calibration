...
! random given number
    complex(kind=realtype), parameter :: k2=0.6_realtype
! mach number preconditioner activation
    complex(kind=realtype), parameter :: m0=0.2_realtype
...
! test phase
    complex(kind=realtype), parameter :: cpres=4.18_realtype
    complex(kind=realtype), parameter :: temp=297.15_realtype
!
!     local variables
!
    complex(kind=realtype) :: k3, h, velxrho, velyrho, velzrho, sos, hinf
    complex(kind=realtype) :: resm, a11, a12, a13, a14, a15, a21, a22, a23&
&   , a24, a25, a31, a32, a33, a34, a35
    complex(kind=realtype) :: a41, a42, a43, a44, a45, a51, a52, a53, a54, &
&   a55, b11, b12, b13, b14, b15
    complex(kind=realtype) :: b21, b22, b23, b24, b25, b31, b32, b33, b34, &
&   b35
    complex(kind=realtype) :: b41, b42, b43, b44, b45, b51, b52, b53, b54, &
&   b55
...
! input
    ...
    complex(kind=realtype), intent(inout) :: plocald
! working
    integer(kind=inttype) :: i, j, k, ii, istart, iend
    complex(kind=realtype) :: ftmp(3), vx, vy, vz, f_fact(3), q_fact, qtmp&
&   , redim, factor, ostart, oend
    complex(kind=realtype) :: ftmpd(3), vxd, vyd, vzd, f_factd(3), q_factd&
&   , qtmpd, redimd
    complex(kind=realtype), dimension(3) :: tempd
...
! determine the currently active multigrid level.
        if (currentlevel .ceq. groundlevel) then
