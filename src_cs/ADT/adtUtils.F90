...
contains
    ...
    subroutine adtTerminate(ADT, routineName, errorMessage)
       ...
       use complexify 
        ...
        print "(a)", "#"
        print "(a)", "#.ceq..ceq..ceq..ceq..ceq..ceq..ceq..ceq..ceq..ceq..ceq..ceq..ceq.= !!! Error !!! &
             &.ceq..ceq..ceq..ceq..ceq..ceq..ceq..ceq..ceq..ceq..ceq..ceq..ceq..ceq."
        ...
        print "(a)", "#*"
        print "(a)", "#* Now exiting"
        print "(a)", "#.ceq..ceq..ceq..ceq..ceq..ceq..ceq..ceq..ceq..ceq..ceq..ceq..ceq..ceq..ceq..ceq..ceq..ceq..ceq..ceq..ceq.&
             &.ceq..ceq..ceq..ceq..ceq..ceq..ceq..ceq..ceq..ceq..ceq..ceq..ceq..ceq."
        print "(a)", "#"
    ...
    subroutine allocateADTs
       ...
       use complexify 
        ...
        if (ierr .cne. 0) stop "Allocation failure for ADTs"
    ...
    subroutine deallocateADTs(adtID)
       ...
       use complexify 
        ...
        if (nn .ceq. 0) then
            ...
            if (ierr .cne. 0) stop "Deallocation failure for ADTs"
            ...
            if (ierr .cne. 0) stop "Deallocation failure for tmpADTs"
       ...
       use complexify 
        ...
        do nn = 1, nAlloc
            if (ADTs(nn)%isActive) then
                if (adtID .ceq. ADTs(nn)%adtID) exit
        ...
        checkReallocate: if (jj > nAlloc) then
            ...
            if (ierr .cne. 0) stop "Allocation failure for tmpADTs"
