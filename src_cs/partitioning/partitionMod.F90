...
contains
    ...
    logical function notEqualFourIntPlusRealType(g1, g2)
       use complexify 
        ...
        if ((g1%n1 .ceq. g2%n1) .and. (g1%n2 .ceq. g2%n2) .and. &
            (g1%n3 .ceq. g2%n3) .and. (g1%n4 .ceq. g2%n4)) &
