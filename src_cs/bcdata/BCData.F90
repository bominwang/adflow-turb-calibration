 ...
 contains
    ...
    subroutine setBCVarNamesTurb(offset)
       ...
       use complexify 
        ...
        if (equations .cne. RANSEquations) return
    ...
    subroutine BCDataIsothermalWall(boco, bcVarArray, iBeg, iEnd, jBeg, jEnd)
       ...
       use complexify 
        ...
        complex(kind=realType), dimension(iBeg:iEnd, jBeg:jEnd, nbcVarMax) :: bcVarArray
        !
        !      Local variables.
        !
        integer :: ierr
    ...
    subroutine setBCData(bcDataNamesIn, bcDataIn, famLists, sps, &
       ...
       use complexify 
        ...
        complex(kind=realType), dimension(nVar), intent(in) :: bcDataIn
    ...
    subroutine setBCData_d(bcDataNamesIn, bcDataIn, bcDataInd, famLists, sps, &
       ...
       use complexify 
         character, dimension(nVar, maxCGNSNameLen), intent(in) :: bcdatanamesin
        complex(kind=realType), dimension(nVar), intent(in) :: bcDataIn, bcDataInd
        integer(kind=intType), dimension(nVar, nFamMax) :: famLists
        integer(kind=intType), intent(in) :: sps, nVar, nFamMax
        !
        !      Local variables.
    ...
    subroutine setBCData_b(bcDataNamesIn, bcDataIn, bcDataInd, famLists, sps, &
       ...
       use complexify 
         character, dimension(nVar, maxCGNSNameLen), intent(in) :: bcdatanamesin
        complex(kind=realType), dimension(nVar), intent(in) :: bcDataIn
        complex(kind=realType), dimension(nVar), intent(out) :: bcDataInd
        integer(kind=intType), dimension(nVar, nFamMax) :: famLists
        integer(kind=intType), intent(in) :: sps, nVar, nFamMax
    ...
    subroutine extractFromDataSet(bcVarArray)
       ...
       use complexify 
        ...
        ! Input
        complex(kind=realType), dimension(:, :, :) :: bcVarArray
        ...
        do m = 1, nbcVar
            ...
            dataSetLoop: do k = 1, nDataSet
                do l = 1, dataSet(k)%nDirichletArrays
                    if (dataSet(k)%dirichletArrays(l)%arrayName .ceq. &
                        bcVarNames(m)) then
    ...
    subroutine extractFromDataSet_d(bcVarArray, bcVarArrayd)
       ...
       use complexify 
        ...
        ! Input
        complex(kind=realType), dimension(:, :, :) :: bcVarArray, bcVarArrayd
    ...
    subroutine insertToDataSet(bcDataNamesIn, bcDataIn)
       ...
       use complexify 
        ...
        complex(kind=realType), intent(in) :: bcDataIn
        !
        !      Local variables.
        !
        ...
        do m = 1, nbcVar
            ...
            dataSetLoop: do k = 1, nDataSet
                do l = 1, dataSet(k)%nDirichletArrays
                    ...
                    if (dataSet(k)%dirichletArrays(l)%arrayName .ceq. varName) then
    ...
    subroutine insertToDataSet_d(bcDataNamesIn, bcDataIn, bcDataInd)
       ...
       use complexify 
        ...
        !
        character, dimension(:), intent(in) :: bcdatanamesin
        complex(kind=realType), intent(in) :: bcDataIn, bcDataInd
        !
        !      Local variables.
        !
        integer(kind=intType) :: k, l, m, n, q
    ...
    subroutine insertToDataSet_b(bcDataNamesIn, bcDataIn, bcDataInd)
       ...
       use complexify 
        ...
        character, dimension(:), intent(in) :: bcdatanamesin
        complex(kind=realType), intent(in) :: bcDataIn
        complex(kind=realType), intent(out) :: bcDataInd
        !
        !      Local variables.
        !
        integer(kind=intType) :: k, l, m, n, q
    ...
    subroutine setBCDataFineGrid(initializationPart)
       ...
       use complexify 
        ...
        complex(kind=realType), dimension(:, :, :), allocatable :: bcVarArray
        ...
        checkInit: if (initializationPart) then
            ...
            if ((myID .ceq. 0) .and. (j .ceq. 1) .and. printBCWarnings) then

                print "(a)", "#"
                print "(a)", "#*.ceq..ceq..ceq..ceq..ceq..ceq..ceq..ceq..ceq..ceq. !!! Warning !!! &
                     &.ceq..ceq..ceq..ceq..ceq..ceq..ceq..ceq..ceq..ceq..ceq."
                print "(a)", "# Radial boundary data given while no &
                     &rotation axis is present."
                print "(a)", "# It is assumed that the X-axis is the axial &
                     &direction."
                print "(a)", "#*.ceq..ceq..ceq..ceq..ceq..ceq..ceq..ceq..ceq..ceq..ceq..ceq..ceq..ceq..ceq..ceq..ceq..ceq.=&
                     &.ceq..ceq..ceq..ceq..ceq..ceq..ceq..ceq..ceq..ceq..ceq."
                print "(a)", "#"
    ...
    subroutine setBCDataFineGrid_d(initializationPart)
       ...
       use complexify 
        ...
        logical :: allFlowSupersonicInflow, allTurbSupersonicInflow
        integer(kind=intType) :: i, j, sps, iBeg, iEnd, jBeg, jEnd
        complex(kind=realType), dimension(:, :, :), allocatable :: bcVarArray, bcVarArrayd
    ...
    subroutine setBCDataCoarseGrid
       ...
       use complexify 
        ...
        complex(kind=realType) :: var, hDim, TDim
            ...
            spectralLoop: do sps = 1, nTimeIntervalsSpectral
                domainsLoop: do i = 1, nDom
                    ...
                    bocoLoop: do j = 1, nBocos
                        ...
                        if (((BCType(j) .ceq. SubsonicInflow) .and. &
                             (BCData(j)%subsonicInletTreatment .ceq. totalConditions)) .or. &
                            (BCType(j) .ceq. DomainInterfaceTotal)) then
    ...
    contains
       ...
       use complexify 
            ...
            !        Subroutine arguments.
            !
            complex(kind=realType), dimension(:, :), pointer :: varCoarse
            complex(kind=realType), dimension(:, :), pointer :: varFine
            !
            !        Local variables.
            !
