subroutine getAreas(areas, pts, npts, sps_in, axis)
    ...
    complex(kind=realType), intent(in) :: pts(3, npts), axis(3)
    complex(kind=realType), intent(out) :: areas(3, npts)

    integer(kind=intType) :: mm, nn, i, j, ii, sps
    integer(kind=intType) :: iBeg, iEnd, jBeg, jEnd
    integer(kind=intType) :: lower_left, lower_right, upper_left, upper_right
    complex(kind=realType) :: da, fact, fact2
...
subroutine getAreaSensitivity(darea, pts, npts, sps_in, axis)
    ...
    integer(kind=intType), intent(in) :: npts, sps_in
    complex(kind=realType), intent(in) :: pts(3, npts), axis(3)
    complex(kind=realType), intent(out) :: darea(3, npts)

    integer(kind=intType) :: mm, nn, i, j, ii, sps
    integer(kind=intType) :: iBeg, iEnd, jBeg, jEnd
    integer(kind=intType) :: lower_left, lower_right, upper_left, upper_right
    complex(kind=realType) :: area, areab, pt1b(3), pt2b(3), pt3b(3), pt4b(3)
    complex(kind=realType) :: fact, fact2, da
...
subroutine quad_area(p1, p2, p3, p4, axis, area)
    ...
    ! I/O
    complex(kind=realType), intent(in) :: p1(3), p2(3), p3(3), p4(3), axis(3)
    complex(kind=realType), intent(out) :: area

    ! Working
    complex(kind=realType) :: v1(3), v2(3), sss(3)
...
! I/O
    complex(kind=realtype), INTENT(IN) :: p1(3), p2(3), p3(3), p4(3), axis(3)
    complex(kind=realtype) :: p1b(3), p2b(3), p3b(3), p4b(3)
    complex(kind=realtype) :: area
    complex(kind=realtype) :: areab
! Working
    complex(kind=realtype) :: v1(3), v2(3), sss(3)
    complex(kind=realtype) :: v1b(3), v2b(3), sssb(3)
    complex(kind=realtype) :: tempb1
    complex(kind=realtype) :: tempb0
!     Complexify removed intrinsic line here
    complex(kind=realtype) :: tempb
! Vectors for Cross Product
    v1(:) = p4 - p1
    v2(:) = p3 - p2
! Cross Product
