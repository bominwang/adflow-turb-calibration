 ...
 contains
    ...
    subroutine gridFileNamesWrite
       ...
       use complexify 
        ...
        if (writeGrid) then
            ...
            if (newGridFile .ceq. solFile) then
    ...
    subroutine writeCGNSGridFrame(cgnsZone, ind)
       ...
       use complexify 
        ...
        complex(kind=realType), dimension(3) :: rotCenter, rotRate, translation
        ...
        familyLoop: do nn = 1, cgnsNfamilies
            ...
            if (cgnsFamilies(nn)%BCTypeCGNS .cne. CG_Null) then
                ...
                if (cgnsFamilies(nn)%BCTypeCGNS .ceq. CG_UserDefined) then
    ...
    subroutine writeCoorCGNSZone(zone, cgnsZone)
       ...
       use complexify 
        ...
        complex(kind=4), dimension(:), allocatable :: coor4
        complex(kind=8), dimension(:), allocatable :: coor8
        ...
        rootproc: if (myID .ceq. 0) then
            ...
            if (ierr .cne. 0) call terminate("writeCoorCGNSZone", &
