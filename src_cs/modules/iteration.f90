...
!
    ...
    complex(kind=realType) :: rFil, rfilb

    ! t0Solver: Reference time for the solver.

    complex(kind=realType) :: t0Solver
    ...
    complex(kind=realType), dimension(:), allocatable :: coefTime
    ...
    complex(kind=realType) :: CFLMonitor = 0.0
    ...
    complex(kind=realType), dimension(:), allocatable :: coefTimeALE
    complex(kind=realType), dimension(:, :), allocatable :: coefMeshALE
    ...
    complex(kind=realType) :: totalR0, totalRStart, totalRFinal, totalR
    complex(kind=realType) :: rhoRes0, rhoResStart, rhoResFinal, rhoRes
    complex(kind=realType) :: ordersConverged = 16.0_realType
