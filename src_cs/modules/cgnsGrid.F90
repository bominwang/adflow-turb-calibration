...
!
    type cgnsBCDataArray
        ...
        complex(kind=realType), pointer, dimension(:) :: dataArr
    ...
    TYPE CGNSBCDATAARRAY_D
        complex(kind=realtype), DIMENSION(:), POINTER :: dataarr
...
!
        ...
        complex(kind=realType) :: priority = one
...
!
    ...
    complex(kind=realType), allocatable, dimension(:, :) :: massFlowFamilyInv
    complex(kind=realType), allocatable, dimension(:, :) :: massFlowFamilyDiss
