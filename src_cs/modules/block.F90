module block
    ...
    type viscSubfaceType
        ...
        complex(kind=realType), dimension(:, :, :), pointer :: tau, q
        complex(kind=realType), dimension(:, :), pointer :: uTau

    end type viscSubfaceType

    type rPtr
        complex(kind=realType), dimension(:, :, :), pointer :: var
    end type rPtr
    ...
    type BCDataType
        ...
        complex(kind=realType), dimension(:, :), pointer :: rface
        complex(kind=realType), dimension(:, :, :), pointer :: F, Fv, Fp
        complex(kind=realType), dimension(:, :, :), pointer :: T, Tv, Tp
        complex(kind=realType), dimension(:, :), pointer :: area
        complex(kind=realType), dimension(:, :), pointer :: CpTarget
        integer(kind=realType), dimension(:, :), pointer :: surfIndex

        ! Generic pointers for performing a globalized reduction.
        complex(kind=realType), dimension(:, :), pointer :: nodeVal
        complex(kind=realType), dimension(:, :), pointer :: cellVal
        ...
        complex(kind=realType), dimension(3) :: symNorm
        ...
        complex(kind=realType), dimension(:, :), pointer :: TNS_Wall
        ...
        complex(kind=realType), dimension(:, :, :, :), pointer :: normALE
        complex(kind=realType), dimension(:, :, :), pointer :: rFaceALE
        complex(kind=realType), dimension(:, :, :, :), pointer :: uSlipALE
        complex(kind=realType), dimension(:, :), pointer :: nodeHeatFlux
        complex(kind=realType), dimension(:, :), pointer :: cellHeatFlux
        ...
        complex(kind=realType), dimension(:, :), pointer :: ptInlet, ttInlet, htInlet
        complex(kind=realType), dimension(:, :), pointer :: flowXDirInlet, flowYDirInlet, flowZDirInlet
        ...
        complex(kind=realType), dimension(:, :), pointer :: rho
        complex(kind=realType), dimension(:, :), pointer :: velX, velY, velZ
        complex(kind=realType), dimension(:, :), pointer :: ps
        ...
        complex(Kind=realType), dimension(:, :), pointer :: delta
        complex(Kind=realType), dimension(:, :), pointer :: deltaNode

    end type BCDataType

    type surfaceNodeWeightArray
        complex(kind=realType), dimension(:, :, :), pointer :: weight
    ...
    type fringeType
        ...
        complex(kind=realType) :: donorFrac(3)
    ...
    type blockType
        ...
        complex(kind=realType), dimension(:, :, :, :), pointer :: x, xtmp
        ...
        complex(kind=realType), dimension(:, :, :, :), pointer :: uv
        ...
        complex(kind=realType), dimension(:, :, :, :, :), pointer :: rotMatrixI, rotMatrixJ, rotMatrixK
        ...
        complex(kind=realType), dimension(:, :, :, :), pointer :: w, wtmp
        complex(kind=realType), dimension(:, :, :, :, :), pointer :: dw_deriv
        ...
        complex(kind=realType), dimension(:, :, :, :), pointer :: dwtmp, dwtmp2
        ...
        complex(kind=realType), dimension(:, :, :), pointer :: fc
        ...
        complex(kind=realType), dimension(:, :, :), pointer :: d2Wall, filterDES
        ...
        complex(kind=realType), dimension(:, :, :, :), pointer :: bmti1, bmti2
        complex(kind=realType), dimension(:, :, :, :), pointer :: bmtj1, bmtj2
        complex(kind=realType), dimension(:, :, :, :), pointer :: bmtk1, bmtk2
...
contains
    ...
    logical function lessEqualFringeType(g1, g2)
       ...
       use complexify 
        ...
        if (fringeSortType .ceq. sortByDonor) then
        ...
        else if (fringeSortType .ceq. sortByReceiver) then
