...
!
    ...
    complex(kind=realType), dimension(:), allocatable :: CpTRange
    complex(kind=realType), dimension(:), allocatable :: CpEint
    complex(kind=realType), dimension(:), allocatable :: CpHint
