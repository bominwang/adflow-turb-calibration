...
!
    ...
    complex(kind=realType), dimension(:), allocatable :: monLoc
    complex(kind=realType), dimension(:), allocatable :: monGlob
    complex(kind=realType), dimension(:), allocatable :: monRef
    complex(kind=realType) :: MassFluxL, MassFluxG  ! eran-msf
...
!
    ...
    complex(kind=realType), dimension(:, :, :), allocatable :: solverDataArray
...
!
    ...
    complex(kind=realType) :: timeUnsteady, timeUnsteadyRestart
