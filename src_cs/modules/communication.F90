...
!
    ...
    type sendCommListType
        ...
        complex(kind=realType), pointer, dimension(:, :) :: interp, interpd
        complex(kind=realType), pointer, dimension(:, :) :: xCen
...
!
    type internalCommType
        ...
        complex(kind=realType), pointer, dimension(:, :) :: donorInterp, donorInterpd
        complex(kind=realType), pointer, dimension(:, :) :: xCen
...
!
    ...
    complex(kind=realType), allocatable, dimension(:) :: sendBuffer
    complex(kind=realType), allocatable, dimension(:) :: recvBuffer
