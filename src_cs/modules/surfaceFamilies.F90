...
#include <petsc/finclude/petsc.h>
    ...
    complex(kind=realType), dimension(:, :), allocatable, target :: zeroCellVal
    complex(kind=realType), dimension(:, :), allocatable, target :: oneCellVal
    complex(kind=realType), dimension(:, :), allocatable, target :: zeroNodeVal
