module BCDataMod
    ...
    complex(kind=realType), dimension(:, :, :), pointer :: xf
    ...
    complex(kind=realType), dimension(3) :: axis, radVec1, radVec2
    ...
    complex(kind=realType), dimension(:, :, :), allocatable :: bcVarArrayd
#endif
