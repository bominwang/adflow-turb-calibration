...
#include <petsc/finclude/petsc.h>
    ...
    complex(kind=realType), parameter :: pi = 3.1415926535897931_realType
    complex(kind=realType), parameter :: eps = 1.e-25_realType
    complex(kind=realType), parameter :: large = 1.e+37_realType
    ...
    complex(kind=realType), parameter :: zero = 0.0_realType
    complex(kind=realType), parameter :: one = 1.0_realType
    complex(kind=realType), parameter :: two = 2.0_realType
    complex(kind=realType), parameter :: three = 3.0_realType
    complex(kind=realType), parameter :: four = 4.0_realType
    complex(kind=realType), parameter :: five = 5.0_realType
    complex(kind=realType), parameter :: six = 6.0_realType
    complex(kind=realType), parameter :: eight = 8.0_realType

    complex(kind=realType), parameter :: half = 0.5_realType
    complex(kind=realType), parameter :: third = one / three
    complex(kind=realType), parameter :: fourth = 0.25_realType
    complex(kind=realType), parameter :: sixth = one / six
    complex(kind=realType), parameter :: eighth = 0.125_realType
    complex(kind=realType), parameter :: threefourth = 0.75_realType
    complex(kind=realType), parameter :: sqrtthree = 1.7320508075688772_realType

    ! radian to degree conversion
    complex(kind=realType), parameter :: degtorad = pi / 180.0_realType
    ...
    complex(kind=realType), parameter :: thresholdReal = 1.e-5_realType
#else
    complex(kind=realType), parameter :: thresholdReal = 1.e-10_realType
#endif
    ...
    complex(kind=realType) :: zoneMarker = 299.0
    complex(kind=realType) :: dataSectionMarker = 357.0
