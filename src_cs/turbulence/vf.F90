 ...
 contains
    ...
    subroutine vfSolve(resOnly)
       ...
       use complexify 
        ...
        complex(kind=realType) :: rhoi, ss, spk, ff1, ff2, ff3, ss1, ss2, ss3
        complex(kind=realType) :: voli, volmi, volpi
        complex(kind=realType) :: xm, ym, zm, xp, yp, zp, xa, ya, za
        complex(kind=realType) :: ttm, ttp, mulm, mulp, muem, muep
        complex(kind=realType) :: c1m, c1p, c10, c2m, c2p, c20
        complex(kind=realType) :: b1, b2, c1, c2, d1, d2
        complex(kind=realType) :: qs, uu, um, up, utau
        complex(kind=realType) :: tke, tep, tv2, tf2, tkea, tepa, tv2a
        complex(kind=realType) :: tkel, tv2l, sle2i, stei
        complex(kind=realType) :: rsct, rnu
        complex(kind=realType) :: tu12, tu22, tu32, tu42, tu52
        complex(kind=realType) :: rnu23, dtu23, rblank

        complex(kind=realType), dimension(itu1:itu5) :: tup

        complex(kind=realType), dimension(2:il, 2:jl, 2:kl, 2, 2) :: qq
        complex(kind=realType), dimension(2, 2:max(il, jl, kl)) :: bb, dd, ff
        complex(kind=realType), dimension(2, 2, 2:max(il, jl, kl)) :: cc

        complex(kind=realType), dimension(:, :, :), pointer :: dw2, dvt2, w2, w3
        complex(kind=realType), dimension(:, :), pointer :: rlv2, rlv3
        complex(kind=realType), dimension(:, :), pointer :: rev2, rev3
        complex(kind=realType), dimension(:, :), pointer :: d2Wall2, d2Wall3
            ...
            bocos: do nn = 1, nViscBocos
                ...
                do j = (BCData(nn)%jnBeg + 1), BCData(nn)%jnEnd
                    do i = (BCData(nn)%inBeg + 1), BCData(nn)%inEnd
                        ...
                        if (rvfN .ceq. 1) dvt2(i, j, 2) = (tu42 - w2(i, j, itu4)) * 0.01
    ...
    subroutine keSolve(resOnly)
       ...
       use complexify 
        ...
        complex(kind=realType) :: rhoi, ss, spk, ff1, ff2, ff3
        complex(kind=realType) :: ss1, ss2, ss3
        complex(kind=realType) :: voli, volmi, volpi
        complex(kind=realType) :: xm, ym, zm, xp, yp, zp, xa, ya, za
        complex(kind=realType) :: ttm, ttp, mulm, mulp, muem, muep
        complex(kind=realType) :: c1m, c1p, c10, c2m, c2p, c20
        complex(kind=realType) :: b1, b2, c1, c2, d1, d2
        complex(kind=realType) :: qs, uu, um, up, utau
        complex(kind=realType) :: tke, tep, tv2, tkea, tepa, tv2a
        complex(kind=realType) :: tv2l, stei, sle2i
        complex(kind=realType) :: rnu23, tu12, tu22, tu52, prod2, dtu23
        complex(kind=realType) :: factor, rblank
        ...
        do k = 2, kl
            do j = 2, jl
                do i = 2, il
                    ...
                    if (rvfN .ceq. 6) alp = rvfN6A * (1.+rvfN6B * sqrt(tkea / tv2l))
