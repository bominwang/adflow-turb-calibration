 ...
 contains
    ...
    subroutine prodKatoLaunder
       ...
       use complexify 
        ...
        complex(kind=realType) :: qxx, qyy, qzz, qxy, qxz, qyz, sijsij
        complex(kind=realType) :: oxy, oxz, oyz, oijoij
        complex(kind=realType) :: fact, omegax, omegay, omegaz
    ...
    subroutine prodWmag2
       ...
       use complexify 
        ...
        complex(kind=realType) :: uuy, uuz, vvx, vvz, wwx, wwy
        complex(kind=realType) :: fact, vortx, vorty, vortz
    ...
    function saNuKnownEddyRatio(eddyRatio, nuLam)
       ...
       use complexify 
        ...
        !      Function type.
        !
        complex(kind=realType) :: saNuKnownEddyRatio
        !
        !      Function arguments.
        !
        complex(kind=realType), intent(in) :: eddyRatio, nuLam
        !
        !      Local variables.
        !
        complex(kind=realType) :: cv13, chi, chi2, chi3, chi4, f, df, dchi
    ...
    subroutine unsteadyTurbTerm(mAdv, nAdv, offset, qq)
       ...
       use complexify 
        ...
        complex(kind=realType), dimension(2:il, 2:jl, 2:kl, mAdv, mAdv), &
            intent(inout) :: qq
        !
        !      Local variables.
        !
    ...
    subroutine saEddyViscosity(iBeg, iEnd, jBeg, jEnd, kBeg, kEnd)
       ...
       use complexify 
        ...
        complex(kind=realType) :: chi, chi3, fv1, rnuSA, cv13
    ...
    subroutine SSTEddyViscosity(iBeg, iEnd, jBeg, jEnd, kBeg, kEnd)
       ...
       use complexify 
        ...
        !
        integer(kind=intType) :: i, j, k, ii, iSize, jSize, kSize
        complex(kind=realType) :: t1, t2, arg2, f2, vortMag
    ...
    subroutine turbAdvection(mAdv, nAdv, offset, qq)
       ...
       use complexify 
        ...
        complex(kind=realType) :: qs, voli, xa, ya, za
        complex(kind=realType) :: uu, dwt, dwtm1, dwtp1, dwti, dwtj, dwtk

        complex(kind=realType), dimension(mAdv) :: impl
    ...
    subroutine tdia3(nb, ne, l, c, u, r)
       ...
       use complexify 
        ...
        complex(kind=realType), dimension(2, nb:ne), intent(inout) :: l, u, r
        complex(kind=realType), dimension(2, 2, nb:ne), intent(inout) :: c
        !
        !      Local variables.
        !
        integer(kind=intType) :: n
        complex(kind=realType) :: deti, f11, f12, f21, f22, r1
    ...
    subroutine vfEddyViscosity(iBeg, iEnd, jBeg, jEnd, kBeg, kEnd)
       ...
       use complexify 
        ...
        complex(kind=realType) :: tke, tep, tkea, tepa, tepl, tv2, tv2a
        complex(kind=realType) :: yp, utau

        complex(kind=realType), dimension(itu1:itu5) :: tup
        complex(kind=realType), dimension(:, :, :), pointer :: ww
        complex(kind=realType), dimension(:, :), pointer :: rrlv, rrev
    ...
    subroutine vfScale
       ...
       use complexify 
        ...
        complex(kind=realType) :: sqrt3
        complex(kind=realType) :: tkea, tepa, tv2a, supi, rn2
        complex(kind=realType) :: rsct, rscl2, rnu, rstrain
    ...
    subroutine initKOmega(pOffset)
       ...
       use complexify 
        ...
        complex(kind=realType) :: rhoi, tmp
    ...
    subroutine kwCDterm
       ...
       use complexify 
        ...
        !
        integer(kind=intType) :: i, j, k
        complex(kind=realType) :: kx, ky, kz, wwx, wwy, wwz
        complex(kind=realType) :: lnwip1, lnwim1, lnwjp1, lnwjm1
        complex(kind=realType) :: lnwkp1, lnwkm1
