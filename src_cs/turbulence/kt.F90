 ...
 contains
    ...
    subroutine ktCDterm
       ...
       use complexify 
        ...
        complex(kind=realType) :: kx, ky, kz, tx, ty, tz, cd
    ...
    subroutine ktSolve(resOnly)
       ...
       use complexify 
        ...
        complex(kind=realType) :: rktGam1
        complex(kind=realType) :: rhoi, ss, spk, sdk, tau, tau2, cd
        ...
        complex(kind=realType) :: nui, voli2, sp2, sm2, spm
        complex(kind=realType) :: taup, taum, gp, gm
        complex(kind=realType) :: b1, b2, c1, c2, d1, d2
        complex(kind=realType) :: qs, uu, um, up, factor, utau, rblank
