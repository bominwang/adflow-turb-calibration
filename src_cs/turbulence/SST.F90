 ...
 contains
    ...
    subroutine SSTSolve(resOnly)
       ...
       use complexify 
        ...
        complex(kind=realType) :: rSSTGam1, rSSTGam2, t1, t2
        complex(kind=realType) :: rSSTGam, rSSTBeta
        complex(kind=realType) :: rhoi, ss, spk, sdk
        ...
        complex(kind=realType) :: rSSTSigkp1, rSSTSigk, rSSTSigkm1
        complex(kind=realType) :: rSSTSigwp1, rSSTSigw, rSSTSigwm1
        complex(kind=realType) :: c1m, c1p, c10, c2m, c2p, c20
        complex(kind=realType) :: b1, b2, c1, c2, d1, d2
        complex(kind=realType) :: utau, qs, uu, um, up, factor, rblank

        complex(kind=realType), dimension(itu1:itu2) :: tup
    ...
    subroutine f1SST
       ...
       use complexify 
        ...
        complex(kind=realType) :: t1, t2, arg1
