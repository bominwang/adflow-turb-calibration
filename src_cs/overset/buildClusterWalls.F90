subroutine buildClusterWalls(level, sps, useDual, walls, famList, nFamList)
    ...
    complex(kind=realType), dimension(:, :), allocatable :: nodesLocal
    complex(kind=realType), dimension(:, :, :), pointer :: xx, xx1, xx2, xx3, xx4 => null()
    ...
    complex(kind=realType), dimension(:, :), allocatable, target :: nodesGlobal
